...
// --- for RAFX GUI updates
const UINT UPDATE_GUI = 3; // sendUpdateGUI() uses this; user does not need to bother

// --- for RAFX->Custom GUI Updates
//     set m_uPlugInEx[EXTERN_UPDATE_GUI] = 1 to flag the GUI for update
//     and GUI will automatically clear the flag after update is done
const UINT EXTERN_UPDATE_GUI = 31; 
